...
// INT0 on AVRs should be connected to RFM69_Si's DIO0 (ex on Atmega328 it's D2, on Atmega644/1284 it's D2)
...
class RFM69_Si {
  public:
    ...
    RFM69_Si(byte slaveSelectPin=RF69_SPI_CS, byte interruptPin=RF69_IRQ_PIN, bool isRFM69HW=false, byte interruptNum=RF69_IRQ_NUM) {
